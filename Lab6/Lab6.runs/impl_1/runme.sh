...
HD_PWD='C:/Users/ma378458/EEE3342C/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_latch.tcl -notrace
